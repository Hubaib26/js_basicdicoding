/* 
Object Composition
Fitur pewarisan pada class begitu legit dalam memangkas duplikasi kode. Kita tidak perlu repetitif 
menulis kode yang sama ketika dua class atau lebih memiliki kemampuan yang sama. Namun, apakah pewarisan 
di JavaScript mampu memecahkan 
masalah yang lebih kompleks? Mari kita cari tahu.

Di dunia nyata, ada banyak peran dari seorang Developer, tetapi ada tiga peran yang mungkin Anda sudah 
familier seperti Front-End Developer, Back-End Developer, DevOps, dan Full-Stack Developer. 
Semuanya masuk ke dalam kategori Developer dan mereka mampu menulis dan mengubah kode (commit changes). 
Selain itu, terdapat juga kemampuan yang spesifik terhadap perannya masing-masing, Front-End Developer 
dapat membangun antarmuka (build UI), Back-End Developer dapat membangun API (build API), dan DevOps 
mampu men-deploy aplikasi. Peran Full-Stack Developer adalah satu-satunya peran yang mampu melakukan 
banyak hal, di samping menulis dan mengubah kode, dia mampu membagun antarmuka, membangun API, 
dan men-deploy aplikasi.
...
Solusinya adalah meninggalkan pewarisan dan gunakan teknik object composition. Jika Anda lihat kembali 
kode di atas, pewarisan mendorong kita untuk menstrukturkan kode dengan pendekatan peran atau identitas 
...
/* Dengan memecah kode berdasarkan kemampuan, ke depannya kita akan lebih mudah dalam membuat 
  ...
  atau peran lain yang membutuhkan kombinasi dari 
  kemampuan-kemampuan yang ada, tanpa ada kode yang repetitif.

Agar lebih mudah dalam membuat objek, kita bisa membuat sebuah fungsi sebagai object creator dengan 
